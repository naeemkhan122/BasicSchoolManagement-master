<?php
	function att()
	{
		echo '<form action="StudentAttendanceInsert.php" method="post">';
		...
		echo '<div class="form-group">
		<select class="form-control" name="atten1" required>
		...
		echo "<label>Status</label>";
				echo '<select class="form-control" name="status1" required>';
		...
		echo '<input class="form-control" name="dateofd1" type="date" value="" required>';
		echo ' <br>';
